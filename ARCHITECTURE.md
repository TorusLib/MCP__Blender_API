...
- [Кэш поиска](#кэш-поиска)
- [Производительность](#производительность)
- [Батники — портативность](#батники--портативность)
- [Кэш поиска — автоочистка](#кэш-поиска--автоочистка)
- [Конфиг](#конфиг)
- [Новые версии Blender](#новые-версии-blender)
- [HTTP API](#http-api)
...
Подробная структура и что попадает в git — см. [README.md](../README.md) и [START_HERE.md](../START_HERE.md).
